...
apt-get -y install git cmake libelf-dev libelf1 libiberty-dev libboost-all-dev golang \
  libtool autoconf pkg-config python-dev lzma lzma-dev sudo liblzma-dev liblz-dev \
  liblz1 valgrind valgrind-dbg gdb htop nasm binwalk binutils strace ltrace unzip \
